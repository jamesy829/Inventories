...
describe 'pagination' do
  it_behaves_like 'pager', route: -> { manufacturers_path }, factory_girl: :manufacturer
  # # before(:each) { FactoryGirl.create_list(:manufacturer, 30) }

  # context 'on first page', js: true do
  #   before(:each) { visit manufacturers_path;binding.pry }
  ...
  # it 'previous and next are clickable'
end
